# Taller Nivel 5: Módulo de Profesores

Este proyecto cumple con los estándares Clean Architecture de N-Capas definidos en `ARCHITECTURE_GUIDELINES.md`.
Se ha implementado el ciclo completo para la entidad **Profesor**: Controladores, Servicios, Repositorios, DTOs y Manejo de Excepciones global. Además de validar la inyección correcta de dependencias.
